...
describe('FinishedGameComponent', () => {
  ...
  it('should create the component finished game', () => {
    const fixture = TestBed.createComponent(FinishedGameComponent);
    const comp = fixture.debugElement.componentInstance;
    expect(comp).toBeTruthy();
  });

  it('should set a new value of initialized to the game status', () => {
    const fixture = TestBed.createComponent(FinishedGameComponent);
    ...
    expect(comp.game.status).toEqual('initialized');
  });

  it('should set a new value of not started to the game status', () => {
    const fixture = TestBed.createComponent(FinishedGameComponent);
    const comp = fixture.componentInstance;
    const buttons = fixture.debugElement.queryAll(By.css('button'));
    comp.game = {
    ...
    expect(comp.game.status).toEqual('not started');
  });
